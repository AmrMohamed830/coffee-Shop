              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="admin-card flex items-center gap-5 p-6 border-l-4 border-green-500">
                  ...
                  <div>
                    ...
                    <h3 className="text-3xl font-black text-[var(--admin-text)]">{historyOrders.reduce((acc, order) => acc + (order?.total || 0), 0).toLocaleString('ar-EG', { style: 'currency', currency: 'EGP' })}</h3>
                  </div>
                </div>
