...
export default function AdminDashboard() {
  ...
  // استخدام البيانات الحقيقية، ولو مش موجودة نستخدم التجريبية
  const orders = (storeOrders && storeOrders.length > 0) ? storeOrders : dummyOrders as unknown as Order[]
  const products = (storeProducts && storeProducts.length > 0) ? storeProducts : dummyProducts as any
  ...
  const uniqueCustomers = (customers && customers.length > 0) ? customers : dummyCustomers as any
