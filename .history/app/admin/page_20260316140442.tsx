        ...
        <>
          ...
          {activeTab === 'stats' && isAccessGranted && (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              {/* كارت ترحيبي لرسوم بيانية لاحقاً */}
              <div className="admin-card text-center py-20 bg-gradient-to-b from-transparent to-black/5 dark:to-white/5">
                 <BarChart3 className="mx-auto mb-4 text-gray-400 opacity-50" size={64} />
                 <h3 className="text-2xl font-bold text-[var(--admin-text)] mb-2">التقارير المتقدمة</h3>
                 <p className="text-gray-500">هذه المساحة مخصصة لإضافة الرسوم البيانية والمؤشرات في المستقبل.</p>
              </div>
            </div>
          )}
