...
export default function AdminDashboard() {
  ...
  if (loadingAuth) {
    return (
      <div className="flex flex-col items-center justify-center w-full" style={{ minHeight: '60vh', backgroundColor: 'var(--admin-bg)' }}>
  ...
  if (!isAuthenticated) {
    return (
      <div className="flex flex-col items-center justify-center w-full text-center p-8" style={{ minHeight: '60vh', backgroundColor: 'var(--admin-bg)' }}>
