              ...
              <div className="flex flex-col md:flex-row items-center gap-4 flex-wrap justify-end">
                ...
                <div className="relative">
                  <button 
                    ...
                    className={`p-2 border rounded-lg flex items-center gap-2 text-sm font-medium transition ${startDate || endDate ? 'bg-blue-50 border-blue-200 text-blue-700' : 'bg-white border-gray-200 text-gray-700 hover:bg-gray-50'}`}
                  >
                    <Calendar size={16} />
                    <span>
                      {startDate || endDate ? (
                  ...
                  {showDatePicker && (
                    <div className="absolute top-full left-0 md:left-auto md:right-0 mt-2 p-4 bg-white border rounded-xl shadow-xl z-20 w-72 animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="relative">
                  <button 
                    ...
                    className="p-2 border rounded-lg flex items-center gap-2 text-sm font-medium bg-white border-gray-200 text-gray-700 hover:bg-gray-50"
                  >
                    <ArrowUpDown size={16} />
                    <span>الترتيب</span>
                  </button>
                  ...
                  {showSortMenu && (
                    <div className="absolute top-full left-0 md:left-auto md:right-0 mt-2 w-48 bg-white border rounded-xl shadow-xl z-20 animate-in fade-in zoom-in-95 duration-200 overflow-hidden">
                      <button onClick={() => { setSortOption('newest'); setShowSortMenu(false) }} className={`w-full text-right px-4 py-2 text-sm hover:bg-gray-50 ${sortOption === 'newest' ? 'bg-gray-50 font-bold' : ''}`}>الوقت: الأحدث للأقدم</button>
                      <button onClick={() => { setSortOption('oldest'); setShowSortMenu(false) }} className={`w-full text-right px-4 py-2 text-sm hover:bg-gray-50 ${sortOption === 'oldest' ? 'bg-gray-50 font-bold' : ''}`}>الوقت: الأقدم للأحدث</button>
                      <button onClick={() => { setSortOption('price-high'); setShowSortMenu(false) }} className={`w-full text-right px-4 py-2 text-sm hover:bg-gray-50 ${sortOption === 'price-high' ? 'bg-gray-50 font-bold' : ''}`}>السعر: الأعلى سعراً</button>
                      <button onClick={() => { setSortOption('price-low'); setShowSortMenu(false) }} className={`w-full text-right px-4 py-2 text-sm hover:bg-gray-50 ${sortOption === 'price-low' ? 'bg-gray-50 font-bold' : ''}`}>السعر: الأقل سعراً</button>
                    </div>
                  )}
                </div>
