...
export default function AdminDashboard() {
  ...
  const isAccessGranted = true // تم إجبار تفعيل وضع المسؤول لرؤية الإحصائيات وكل شيء بدون تعليق
    ...
    <div className="admin-layout flex flex-col md:flex-row">
      ...
      <aside className="admin-sidebar w-full md:w-64 p-6 flex flex-col space-y-8 text-white">
        ...
        <nav className="space-y-4 flex-1">
          ...
          >
            <ShoppingCart size={20}/> الطلبات والإحصائيات
          </button>
        </nav>
      ...
      <main className="flex-1 p-8 space-y-8">
        {!isAccessGranted && activeTab !== 'orders' ? (
           <div className="flex flex-col items-center justify-center h-full text-center text-gray-500">
             ...
             <h2 className="text-2xl font-bold mb-2 text-white">الوصول مقيد</h2>
             <p>الرجاء تفعيل <span className="font-bold text-yellow-400">وضع المسؤول</span> من الشريط العلوي للوصول لهذه الصفحة.</p>
           </div>
        ) : (
        <>
          <header className="flex justify-between items-center">
            <h2 className="text-3xl font-bold text-[var(--admin-text)]">
              ...
              {activeTab === 'orders' && 'الطلبات والإحصائيات'}
