            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              {selectedPeriod && (
                <div className="fixed inset-0 bg-black/60 z-[100] flex items-center justify-center p-4 animate-in fade-in" onClick={() => setSelectedPeriod(null)}>
                  <div className="bg-white dark:bg-gray-900 rounded-2xl w-full max-w-2xl p-6 shadow-2xl relative animate-in zoom-in-95" onClick={e => e.stopPropagation()} dir="rtl">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-4 max-h-[300px] overflow-y-auto border border-gray-100 dark:border-gray-700">
                      {(() => {
                        ...
                        if (periodTopProducts.length === 0) {
                          return <p className="text-center text-gray-500 py-6 font-bold">لا توجد مبيعات في هذه الفترة</p>;
                        }
