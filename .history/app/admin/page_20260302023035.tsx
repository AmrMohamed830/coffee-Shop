          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="admin-card flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm opacity-70 text-black">الطلبات النشطة</p>
              ...
              <div className="admin-card flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm opacity-70 text-black">المبيعات اليومية</p>
              ...
              <div className="admin-card flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm opacity-70 text-black">إجمالي العملاء</p>
              ...
              <tbody>
                {filteredActiveOrders.length > 0 ? sortOrders(filteredActiveOrders).slice(0, visibleActiveCount).map((order) => (
                  <tr key={order.id} className="border-b hover:bg-black/5 dark:hover:bg-white/5 transition">
                    ...
                    <td className="py-4 px-4 text-sm text-black opacity-80">
                      {/* @ts-ignore */}
