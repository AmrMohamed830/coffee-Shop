...
import { Coffee, Package, Users, ShoppingCart, BarChart3, History, Trash2, Edit, Save, X, Search, RotateCcw } from "lucide-react"
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
              ...
              <div className="flex flex-col md:flex-row items-center gap-4 flex-wrap justify-end">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-bold opacity-70">من:</span>
                  <input 
                    type="date" 
                    value={startDate}
                  ...
                  />
                  <span className="text-sm font-bold opacity-70">إلى:</span>
                  <input 
                    type="date" 
                    value={endDate}
