...
import { Coffee, Lock, AlertCircle, ArrowRight, ArrowLeft, UserPlus, User } from "lucide-react";
                ...
                <div className="space-y-3 max-h-[400px] overflow-y-auto pr-1 custom-scrollbar">
                    {users.length > 0 ? users.map(user => (
                        <button
                            ...
                            className="w-full flex items-center gap-4 p-4 rounded-xl text-right transition-all border-2 border-transparent hover:border-primary hover:bg-primary/5 bg-gray-50 dark:bg-zinc-800/50 group"
                        >
