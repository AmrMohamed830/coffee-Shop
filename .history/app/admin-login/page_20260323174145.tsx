...
import { Coffee, Lock, Mail, AlertCircle, ArrowRight, Eye, EyeOff } from "lucide-react";
...
export default function AdminLogin() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            // حفظ تسجيل الدخول على الجهاز مدى الحياة وعدم الخروج عند إغلاق المتصفح
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-zinc-950 p-4" dir="rtl">
            <div className="w-full max-w-md bg-white dark:bg-zinc-900 shadow-2xl rounded-3xl p-8 border border-gray-100 dark:border-zinc-800">
                ...
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h2 className="text-2xl font-black text-black dark:text-white">بوابة الإدارة</h2>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">تسجيل الدخول للمسؤول فقط</p>
                </div>
