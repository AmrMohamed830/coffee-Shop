...
export function AddProductForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // تبسيط المنتج ليناسب المخزن المشترك (نأخذ سعر وصورة الـ 100 جرام كافتراضي)
    const simpleProduct = {
      id: generateId(),
                  ...
                  <div>
                   ...
                   <div className="md:col-span-2">
                    ...
                    <Select onValueChange={handleCategoryChange} value={newProduct.categoryId}>
                      <SelectTrigger className="w-full p-3 rounded-lg border admin-border bg-white/50 outline-none">
