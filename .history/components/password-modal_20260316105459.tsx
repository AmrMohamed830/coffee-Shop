...
export function PasswordModal() {
  ...
  const handleSubmit = () => {
    // تخطي قاعدة البيانات مؤقتاً: لو الباسورد 123456 يفتح فوراً
    if (password === '123456') {
      useAdminStore.setState({ isAccessGranted: true, showPasswordModal: false, passwordError: '' })
    } else {
    ...
    >
      ...
      >
        ...
        <p className="text-sm text-gray-400 mb-6">
          بسبب توقف قاعدة البيانات، الباسورد المؤقت هو: <span className="font-bold text-green-400">123456</span>
        </p>
        <input
          type="password"
          value={password}
